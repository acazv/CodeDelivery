<?php
	...
	{  //Save All
		...
		$sql_delivery_button = "SELECT * FROM store_delivery where snum = '$snum'";
		$result_delivery_button = mysqli_query($con, $sql_delivery_button)or die('Could not query database at this time');
