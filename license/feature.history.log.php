...
<?php
	...
	$pkey_dnum    = (isset($_GET['id4']) ? $_GET['id4'] : null);
...
<?php
	...
	if($view == 'store')
	{
		echo "<label><a href='store.php'>Store View</a> > Packages and Features > History > Logs</label>";
	}
	if($view == 'product')
	{
		echo "<label><a href='store.php'>Product View</a> > Packages and Features > History > Logs</label>";
	}
...
<tr>
  ...
  <th>Date Modified</th>
<?php echo "<th><button style='background-color: #708090; color:white;'><a href='feature.history.php?id=".$view."&id1=".$pkey_store."&id2=".$pkey_feature."&id3=".$pkey_dnum."'>Back</a></button></th>" ; ?>
</tr>
